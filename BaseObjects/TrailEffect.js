...
define(["require", "exports", "./O", "../Application"], function (require, exports, O_1, Application_1) {
    ...
    var TrailEffect = /** @class */ (function (_super) {
        ...
        TrailEffect.prototype.init = function (props) {
        ...
        TrailEffect.prototype.process = function () {
            ...
            if (this.CameraMode == O_1.CAMERA_MODE.CM_UPDATE) {
                Application_1.Application.One.sm.camera.transformPoint([0, 0], 1, this.pos2);
                this.gfx.x = this.pos2[0];
                this.gfx.y = this.pos2[1];
            }
        };
        TrailEffect.prototype.onDestroy = function () {
            this.pointFunc = null;
            this.historyX = null;
            this.historyY = null;
            this.points = null;
