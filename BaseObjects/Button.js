...
define(["require", "exports", "./IO", "../PIXIPlugins/AnimClip", "./TextBox", "../Application"], function (require, exports, IO_1, AnimClip_1, TextBox_1, Application_1) {
    ...
    var Button = /** @class */ (function (_super) {
            ...
            this.gfx.mousedown = function (evt) {
                ...
                if (_this.hoverMode) {
                    ...
                    if (_this.clickAnimation) {
                        _this._upTween = Application_1.Application.One.killTweens(_this._upTween);
        ...
        Button.prototype.onDestroy = function () {
            this._downTween = Application_1.Application.One.killTweens(this._downTween);
            this._upTween = Application_1.Application.One.killTweens(this._upTween);
            if (this.gfx) {
        ...
        Button.prototype.highlight = function () {
            ...
            var loop = 0;
            if (this.__highlight)
                this.__highlight = Application_1.Application.One.killTweens(this.__highlight);
            ...
            this.wait(0.12).call(function () {
                ...
                _this.__highlight = Application_1.Application.One.killTweens(_this.__highlight);
            }).apply();
        };
